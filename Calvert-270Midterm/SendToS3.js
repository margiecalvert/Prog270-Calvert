...
var bucketName = 'mmc270.elvenware.com';
...
function writeFile(localFileName, nameOnS3, binary) {
	...
	nameOnS3 = "OldCapitalsofThailand" + nameOnS3;
...
writeFile('margieData.html', '/margieData.html', false);
writeFile('moreinfo.html', '/moreinfo.html', false);
writeFile('ayutthaya.html', '/ayutthaya.html', false);
writeFile('sukhothai.html', '/ayutthaya.html', false);
//listBuckets(s3);
//listBuckets(s3);
